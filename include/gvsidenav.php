...
<ul class="sidenav collapsible sidenav-fixed" id="slide-out">
        ...
        <li><a href="gvdashboard.php"><i class="material-icons">home</i>Trang chủ</a></li>
		...
		<li>
          ...
          <div class="collapsible-body">
            <ul>
               <ul>
              <li>
              <li><a href="xetduyetdiemrl.php"><i class="material-icons">tasks</i>Xét duyệt điểm</a></li>
              <li><a href="gvdsdiemrl.php"><i class="material-icons">tasks</i>Danh sách điểm</a></li>
              </li>
            </ul>
            </ul>
          </div>
