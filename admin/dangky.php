<?php
require_once('../include/uheader.php');
?>
                    ...
                    <div class="row">
                     ...
                     <input type="file" name="image" class="dropify" data-show-remove="false" data-default-file="../images/user.png" />
                        ...
                        <div class="col l8 center large">
							<a href="../index.php"  class="btn" style="width:45%"><i >Đăng nhập</i></a>
							<button type="submit" name="submit" style="width:45%" class="btn">Đăng ký</button>
						</div>
                    </div>
